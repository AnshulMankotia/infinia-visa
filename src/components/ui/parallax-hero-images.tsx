...
export type ParallaxImageInput = { src: string; alt: string };

export interface ParallaxHeroImagesProps {
  images: ParallaxImageInput[];
  className?: string;
  ...
  return (
    ...
    >
      <Image
        ...
        width={640}
        height={480}
        sizes="(max-width: 640px) 40vw, (max-width: 1024px) 28vw, 24vw"
        className={cn(
          "aspect-4/3 h-20 w-32 rounded-xl object-cover shadow-[0_18px_40px_-24px_rgba(22,16,10,0.5)] ring-1 ring-ink/10 sm:h-32 sm:w-48 md:h-40 md:w-60",
          imageClassName,
        )}
      />
    </motion.div>
