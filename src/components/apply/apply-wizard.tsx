  ...
  return (
    <div className="grid h-[100dvh] overflow-hidden bg-ground xl:grid-cols-[65%_35%]">
      ...
      <section className="flex min-h-0 min-w-0 flex-col xl:border-r xl:border-line">
        <header className="flex h-[68px] shrink-0 items-center justify-between border-b border-line px-4 md:px-8 xl:px-10">
        ...
        <nav aria-label="Application steps" className="shrink-0 border-b border-line bg-ground px-4 py-4 md:px-8 xl:px-10">
        ...
        <main
          data-lenis-prevent
          className="application-form-scroll min-h-0 flex-1 overflow-x-hidden overflow-y-auto overscroll-contain px-4 py-7 md:px-8 lg:py-8 xl:px-10"
        >
        ...
        <footer className="flex h-[84px] shrink-0 items-center justify-between border-t border-line bg-ground px-4 md:px-8 xl:px-10">
          <button
            type="button"
...
function ApplicationGuide({
  ...
  const panels = [
    ...
    {
      icon: IconScan,
      title: "A passport is the fastest start.",
      copy: "Scan the photo page and we will fill the traveller details for you. You can review and correct every field before moving on.",
      facts: [
        { label: "Secure scan", value: "AES-256 encrypted" },
        { label: "You stay in control", value: "Review every field" },
      ],
    },
    {
      icon: IconFileText,
...
function ReviewStep({
  ...
  return (
    <section>
      ...
      <div className="grid items-start gap-5 xl:grid-cols-2 2xl:grid-cols-[minmax(0,0.9fr)_minmax(0,1.15fr)_minmax(20rem,0.95fr)]">
        ...
        <div className="min-w-0 overflow-hidden rounded-2xl border border-line bg-paper xl:col-span-2 2xl:col-span-1">
          <div
            aria-hidden="true"
